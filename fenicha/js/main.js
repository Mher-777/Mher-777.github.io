        ...
        success: function (data) {
            for (let i = 0; i < 100; i++) {
                ...
                $('.our-gallery__inner').append(
                    `
                        <div id="${productId}" class="our-gallery__item" style="background-image: url(${productImages});">
                            <div class="our-gallery__item-box">
                                <a data-fancybox="images" href="${productImages}"
                                   class="our-gallery__item-link">L</a>
                                <div class="our-gallery__item-text">${productTitle}</div>
                            </div>
                        </div>`
                )
            }
